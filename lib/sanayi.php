<?php
use League\OpenAPIValidation\Schema\TypeFormats\None;
...
class Sanayi{
    ...
    public function disableClient($remark, $id) {
        $url = $this->base_url . '/panel/inbound/list';
        $curl = curl_init();
        curl_setopt_array($curl, array(
          CURLOPT_URL => $url,
    ...
    public function enableClient($remark, $id) {
        $url = $this->base_url . '/panel/inbound/list';
        $curl = curl_init();
        curl_setopt_array($curl, array(
          CURLOPT_URL => $url,
    ...
    public function deleteClient($remark, $id) {
        $url = $this->base_url . '/panel/inbound/list';
        $curl = curl_init();
        curl_setopt_array($curl, array(
          CURLOPT_URL => $url,
        ...
        $update_url = $this->base_url . '/panel/api/inbounds/'.$id.'/delClient/'. $uuid;
    ...
    public function renew($remark, $limit , $date , $id) {
        $url = $this->base_url . '/panel/inbound/list';
        $curl = curl_init();
        curl_setopt_array($curl, array(
          CURLOPT_URL => $url,
